---
title: "Respuesta germinativa de semillas de frijol (Phaseolus vulgaris L.)"
author: "Eros Chasquivol, Mikey Cubas, Jefferson Lalangui, Naeider Ramirez, Isaac Santillan"
format:
  html:
    theme: cosmo
    toc: true
...
![](images/materilaes 02-01.jpeg){fig-align="center" width="235"}

**Figura 1:** Materiales empleados en el experimento
...
![](images/semillas%20frijol.jpeg){width="463"}

**Figura 2:** Semillas utilizadas.

# RESULTADOS Y DISCUSIONES

## Datos de las evalauciones diarias
...
**Figura 3:** Resultados diarios de la germinacion con/sin luz. **(A**) Dia uno. **(B)** segundo dia con. **(C)** Segundo dia sin. **(D)** Tercer dia con. (**E)** Tercer dia sin. **(F)** Cuarto dia con. **(G**) Cuarto dia sin.
...
![](images/semulla%20germinada.jpeg){fig-align="center" width="484"}

**Figura 3:** Número de semillas germinadas en frijol bajo condiciones de luz y oscuridad.
...
![](images/foto%20germinacion.jpeg){fig-align="center" width="485"}

**Figura 4:** Porcentaje de germinación de semillas de Phaseolus vulgaris L. bajo condiciones de luz y oscuridad
